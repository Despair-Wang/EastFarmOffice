            ...
            @foreach ($cates as $cate)
                <div class="editPostItem row" data-post-id="{{ $cate->id }}">
                    ...
                    <div class="editArea col-3">
                        <a class="btn btn-primary px-3 mr-2" href="{{ '/pedia/category/' . $cate->id . '/edit' }}">編輯</a>
...
@endsection
@section('customJs')
    <script type="text/javascript" src="{{ asset('js/pedia/category/list.js')}}"></script>
@endsection
